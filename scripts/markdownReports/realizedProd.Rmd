...
Variability in productivity in recent years makes it difficult to interpret. May need to directly compare simulated R/S from alpha values equivalent to Sue's Kalman filter estimates and see how they compare rather than using observed alone. Unsure whether this should also imply shifting the reference values. 